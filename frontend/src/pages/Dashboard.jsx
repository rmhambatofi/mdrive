          ...
          <div className="max-w-7xl mx-auto">
            ...
            <div className="relative mb-6">
              ...
              <div className={`absolute inset-0 transition-opacity duration-150 ${hasSelection ? 'opacity-100' : 'opacity-0 pointer-events-none'}`}>
                <div className="h-full bg-white border border-gray-200 shadow-sm rounded-xl flex items-center px-4 space-x-1">
                  ...
                  <button
                    ...
                    className="flex items-center space-x-1.5 px-3 py-1.5 text-sm text-gray-700 hover:bg-gray-100 rounded-md transition"
                  >
                  ...
                  <button
                    ...
                    className="flex items-center space-x-1.5 bg-gray-100 hover:bg-gray-200 rounded-full px-3 py-1 transition"
                  >
